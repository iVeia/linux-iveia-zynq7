 ...
 * Other macros
 */
#define MT9P111_MODULE_NAME		"mt9p111"
...
/*i2c adress for MT9P111*/
#define MT9P111_I2C_ADDR		(0x78 >> 1)
...
#define MT9P111_VGA_30FPS  (1130)
#define MT9P111_QVGA_30FPS  (1131)

#define MT9P111_CLK_MAX		(54000000) /* 54MHz */
#define MT9P111_CLK_MIN		(6000000)  /* 6Mhz */

#endif				/* ifndef _MT9P111_H */
