 ...
 */
#ifndef _BOARD_IV_ATLAS_I_LPE_
#define _BOARD_IV_ATLAS_I_LPE_
...
struct iv_io_board_info {
	 ...
	 *	early_init is called at very beginning of atlas-i-lpe's init_machine()
	 *	late_init is called at very end of atlas-i-lpe's init_machine()
