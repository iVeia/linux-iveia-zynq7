...
static int beagle_mt9p111_s_power(struct v4l2_subdev *subdev, int on)
{
...
static int beagle_mt9p111_configure_interface(struct v4l2_subdev *subdev,
					      u32 pixclk)
{
	struct isp_device *isp = v4l2_dev_to_isp_device(subdev->v4l2_dev);
...
static struct mt9p111_platform_data beagle_mt9p111_platform_data = {
	.s_power		= beagle_mt9p111_s_power,
	.configure_interface	= beagle_mt9p111_configure_interface,
};


#define MT9P111_I2C_BUS_NUM		7

static struct i2c_board_info beagle_camera_i2c_devices[] = {
	{
		I2C_BOARD_INFO(MT9P111_MODULE_NAME, MT9P111_I2C_ADDR),
		.platform_data = &beagle_mt9p111_platform_data,
	},
};
...
static struct isp_subdev_i2c_board_info beagle_camera_primary_subdevs[] = {
	{
		...
		.i2c_adapter_id = MT9P111_I2C_BUS_NUM,
	},
	{ NULL, 0 },
};
